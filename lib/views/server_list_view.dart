  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.bolt_rounded, color: Color(0xFF00FF88)),
            tooltip: 'Ping Test All Nodes',
            onPressed: () => serverProvider.testAllPings(),
          ),
          IconButton(
            icon: const Icon(Icons.add_link_rounded, color: Color(0xFF00D4FF)),
            tooltip: 'Import Subscription',
            onPressed: () => _showAddSubscriptionDialog(context),
          ),
          IconButton(
            icon: const Icon(Icons.add_rounded, color: Color(0xFF9D00FF)),
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              style: const TextStyle(color: Colors.white, fontSize: 13),
              decoration: InputDecoration(
                hintText: 'Search servers by name, host, protocol...',
                hintStyle: const TextStyle(color: Color(0xFF5A6678)),
              ...
              child: servers.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.cloud_off_rounded, size: 48, color: const Color(0xFF38435E)),
                          const SizedBox(height: 12),
                          const Text(
                            'No servers available',
                            style: TextStyle(color: Color(0xFF7E8B9E), fontSize: 14, fontWeight: FontWeight.w600),
                          ),
